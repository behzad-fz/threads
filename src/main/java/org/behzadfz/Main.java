...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String sqlSelectAllPersons = "SELECT * FROM rockets";
        String connectionUrl = "jdbc:mysql://localhost:3306/java_threads?serverTimezone=UTC";
        ...
        try (Connection conn = DriverManager.getConnection(connectionUrl, "root", "1234");
            ...
            while (rs.next()) {
                ...
                String manufacturor = rs.getString("manufacturor");
                Date createdAt = rs.getDate("created_at");

                System.out.println(id + " - " + name + " - " + manufacturor + " - " + createdAt.toString());
            }
